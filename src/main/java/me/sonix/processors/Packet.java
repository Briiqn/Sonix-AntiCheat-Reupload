package me.sonix.processors;

import com.comphenix.protocol.PacketType;
import com.comphenix.protocol.events.PacketContainer;
import com.comphenix.protocol.wrappers.EnumWrappers;
import me.sonix.wrappers.*;
...
public class Packet {
    ...
    private WrapperPacketInTransaction transactionWrapper;

    private WrapperPlayServerEntityVelocity velocityWrapper;
    private boolean movement, rotation, flying, isPlace, velocity;
    ...
    public Packet(PacketContainer container, long timeStamp) {
        ...
        switch (this.type = Type.fromContainer(container)) {
            ...
            case TRANSACTION:
                ...
                this.transactionWrapper = new WrapperPacketInTransaction(container);
            ...
            case SERVER_ENTITY_VELOCITY:
                ...
                this.velocityWrapper = new WrapperPlayServerEntityVelocity(container);
    ...
    public boolean isClientHeltItemSLot() {return PacketType.Play.Client.HELD_ITEM_SLOT.isClient();}
    public boolean isServerHeltItemSLot() {return PacketType.Play.Server.HELD_ITEM_SLOT.isServer();}
    ...
    public WrapperPlayServerEntityVelocity getVelocityWrapper() {
    ...
    public boolean isTeleport() { return type == Type.SERVER_POSITION; }
}